<?php
	...
	if(!empty($_GET['username']) && $_GET['username'] != ""){
		...
		$search_barang 	= mysqli_query($connect,"SELECT * FROM tbl_barang WHERE id_barang='$id_barang'");
		...
		<div class='row'>
            ...
            ?>
				<form action="request-barang.php" method="post">
					...
					<input class="form-control" type="hidden" name="id_user" required  value="<?php echo $id_user;?>" readonly>
					<label>Nama Peminjam</label>
					<input class="form-control" type="" name="nama_peminjam" required="">
					<label>No Telpon</label>
					<input class="form-control" type="" name="telpon" required>
					
					<input class="form-control" type="hidden" name="id_barang" required readonly value="<?php echo $data['id_barang'];?>">
