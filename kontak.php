          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="pemberitahuan.php?username=<?php echo $username;?>"> Pemberitahuan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="barang-dipinjam.php?username=<?php echo $username;?>"> Barang Dipinjam </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="barang-dikembalikan.php?username=<?php echo $username;?>">Barang Dikembalikan</a>
                </li>
              </ul>
              <?php
					}
